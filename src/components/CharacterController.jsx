...
export const CharacterController = ({
        ...
        useFrame((_, delta) => {
            ...
            if (controls.current) {
                const cameraDistanceY = window.innerWidth < 1024 ? 15 : 17;
                const cameraDistanceZ = window.innerWidth < 1024 ? 20 : 26;
                ...
                >
                    ...
                    <group ref={character}>
                        <CharacterSoldier
                            ...
                            animation={animation}
                        />
                        { usePlayer && <Crosshair position={[WEAPON_OFFSET.x, WEAPON_OFFSET.y, WEAPON_OFFSET.z]} /> }
                    </group>
